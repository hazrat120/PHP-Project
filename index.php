                        ...
                        ?>
                            <div class="item">
                                ...
                                <div class="text">
                                    ...
                                    <?php else: ?>
                                        <p><a href="product.php?id=<?php echo $row['id']; ?>"><i class="fa fa-shopping-cart"></i> Add to Cart</a></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-carousel">
                        ...
                        <?php
                        $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? ORDER BY id DESC LIMIT " . $total_latest_product_home);
